...
FIELD_ENCRYPTION_KEY = os.environ.get('FIELD_ENCRYPTION_KEY', 'pVfI5aBk3jDbEz2S-omZLsapC6Pirh51V7AxXuu9yDw=')
...
# Cache Configuration (Used for SimpleJWT Blacklist and Rate Limiting)
CACHES = {
    'default': {
